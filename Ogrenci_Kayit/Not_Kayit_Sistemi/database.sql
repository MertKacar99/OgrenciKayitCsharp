...
/****** Object:  Database [DbNotKayit]    Script Date: 29.08.2023 19:11:58 ******/
CREATE DATABASE [DbNotKayit]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'DbNotKayit', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.MSSQLSERVER\MSSQL\DATA\DbNotKayit.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'DbNotKayit_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.MSSQLSERVER\MSSQL\DATA\DbNotKayit_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
